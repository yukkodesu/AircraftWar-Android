...
public class ImageManager {
    ...
    public static Texture HERO_IMAGE = new Texture("images/hero.png");
    public static Texture HERO_BULLET_IMAGE = new Texture("images/bullet_hero.png");
    public static Texture ENEMY_BULLET_IMAGE = new Texture("images/bullet_enemy.png");
    public static Texture MOB_ENEMY_IMAGE = new Texture("images/mob.png");
    public static Texture BOSS_ENEMY_IMAGE = new Texture("images/boss.png");
    public static Texture ELITE_ENEMY_IMAGE = new Texture("images/elite.png");
    public static Texture BOMB_DROP_IMAGE = new Texture("images/prop_bomb.png");
    public static Texture BLOOD_DROP_IMAGE = new Texture("images/prop_blood.png");
    public static Texture BULLET_DROP_IMAGE = new Texture("images/prop_bullet.png");
    public static Texture BACKGROUND_IMAGE1 = new Texture("images/bg.jpg");
    public static Texture BACKGROUND_IMAGE2 = new Texture("images/bg2.jpg");
    public static Texture BACKGROUND_IMAGE3 = new Texture("images/bg3.jpg");
    public static Texture BACKGROUND_IMAGE4 = new Texture("images/bg4.jpg");
    public static Texture BACKGROUND_IMAGE5 = new Texture("images/bg5.jpg");
